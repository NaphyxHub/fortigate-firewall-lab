...
```mermaid
graph TD
    VPN["🖥️ VPN Clients<br/>FortiClient SSL-VPN<br/>10.212.134.x"] --> FW

    FW["🔥 FortiGate NGFW<br/>OAKLAB2-FW<br/>FortiOS v7.4.9"]

    FW -->|port3| SALES["📦 SALES Network<br/>10.10.20.0/24<br/>• Lnx-Sales2<br/>• Win-Sales"]
    FW -->|port5| IT["🖧 IT Network<br/>10.10.30.0/24<br/>• Lnx-IT2 Ubuntu 22.04<br/>• Win-IT"]
    FW -->|port4| DMZ["🏰 DMZ Network<br/>172.30.89.0/24<br/>• WINSRV-DMZ<br/>  └ IIS + DNS Server"]
